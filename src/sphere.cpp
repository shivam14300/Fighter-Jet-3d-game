...
Sphere::Sphere(float x, float y, float z,color_t color) {
    ...
    GLfloat vertex_buffer_data[12000];
    int ptr = 0;
    int ptr1 = 0;
    float r = 5.0;
    for(int j=0;j<18;j++)
    ...
    //     for(int i=0;i<36;i++)
    //     {
    //         vertex_buffer_data[ptr++] = (5.0f-(float)j)*cos((10.0*M_PI*(float)i)/(float)180);
    //         vertex_buffer_data[ptr++] = (5.0f-(float)j)*sin((10.0*M_PI*(float)i)/(float)180);
    //         vertex_buffer_data[ptr++] = 0.0f;
    //         vertex_buffer_data[ptr++] = (5.0f-(float)j)*cos((10.0*M_PI*(float)(i+1))/(float)180);
    //         vertex_buffer_data[ptr++] = (5.0f-(float)j)*sin((10.0*M_PI*(float)(i+1))/(float)180);
    //         vertex_buffer_data[ptr++] = 0.0f;
    //         vertex_buffer_data[ptr++] = (4.9f-(float)j)*cos((10.0*M_PI*(float)(i))/(float)180);
    //         vertex_buffer_data[ptr++] = (4.9f-(float)j)*sin((10.0*M_PI*(float)(i))/(float)180);
    //         vertex_buffer_data[ptr++] = 0.5f;
    //     }
    //     for(int i=36;i<72;i++)
    //     {
    //         vertex_buffer_data[ptr++] = (4.9f-(float)j)*cos((10.0*M_PI*(float)i)/(float)180);
    //         vertex_buffer_data[ptr++] = (4.9f-(float)j)*sin((10.0*M_PI*(float)i)/(float)180);
    //         vertex_buffer_data[ptr++] = 0.5f;
    //         vertex_buffer_data[ptr++] = (4.9f-(float)j)*cos((10.0*M_PI*(float)(i+1))/(float)180);
    //         vertex_buffer_data[ptr++] = (4.9f-(float)j)*sin((10.0*M_PI*(float)(i+1))/(float)180);
    //         vertex_buffer_data[ptr++] = 0.5f;
    //         vertex_buffer_data[ptr++] = (5.0f-(float)j)*cos((10.0*M_PI*(float)(i+1))/(float)180);
    //         vertex_buffer_data[ptr++] = (5.0f-(float)j)*sin((10.0*M_PI*(float)(i+1))/(float)180);
    //         vertex_buffer_data[ptr++] = 0.0f;
    ...
    this->object = create3DObject(GL_TRIANGLES, 18*72*3, vertex_buffer_data, COLOR_BLACK, GL_FILL);
}
