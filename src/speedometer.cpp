...
Speedo::Speedo(float x, float y, float z,color_t color) {
    ...
    vertex_buffer_data1[0] = 0.5f;vertex_buffer_data1[1] = 1.0f;vertex_buffer_data1[2] = 0.0f;
    vertex_buffer_data1[3] = -0.5f;vertex_buffer_data1[4] = 1.0f;vertex_buffer_data1[5] = 0.0f;
    vertex_buffer_data1[6] = 0.0f;vertex_buffer_data1[7] = -4.0f;vertex_buffer_data1[8] = 0.0f;

    this->object = create3DObject(GL_TRIANGLES, 72*3, vertex_buffer_data, COLOR_BLACK, GL_FILL);
    this->object1 = create3DObject(GL_TRIANGLES, 1*3, vertex_buffer_data1, COLOR_STRONGYELLOW, GL_FILL);
}

void Speedo::draw(glm::mat4 VP) {
...
void Speedo::set_position(float x, float y) {
