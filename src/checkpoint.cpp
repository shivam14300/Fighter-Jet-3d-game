...
Checkpoint::Checkpoint(float x, float y, float z,color_t color) {
    ...
    this->object1 = create3DObject(GL_TRIANGLES, 72*3, vertex_buffer_data1, COLOR_RED, GL_FILL);
    // this->object2 = create3DObject(GL_TRIANGLES, 73*3, vertex_buffer_data2, COLOR_WHITE, GL_FILL);
}
